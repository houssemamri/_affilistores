...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{!! asset('css/template-two/style.css') !!}" />
    <link rel="stylesheet" type="text/css" href="{!! asset('css/template-two/schemes/' . $scheme . '.css') !!}" />
</head>
<body>
    <div class="wrapper products">
        <div class="sidebar">
            ...
            <div class="sidebar-wrapper">
                @include('index.template-two.sidenav')               
            </div>
        </div>
        <div class="main-panel">
            @include('index.template-two.nav')
                            ...
                            <div class="card">
                                    @if($policy == 'privacy')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase text-center">Privacy Policy</h3>
                                            <hr>
                                        </div>
                                    ...
                                    @elseif($policy == 'gdpr-compliance')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase">GDPR Compliance</h3>
                                            <hr class="c-hr">
                                        </div>    
                                        <div class="card">
                                            <div class="card-body">
                                    ...
                                    @elseif($policy == 'affiliate-disclosure')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase">Affiliate Disclosure</h3>
                                            <hr class="c-hr">
                                        </div>    
                                        <div class="card">
                                            <div class="card-body">
                                    ...
                                    @elseif($policy == 'cookie-policy')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase">Cookie Policy</h3>
                                            <hr class="c-hr">
                                        </div>    
                                        <div class="card">
                                            <div class="card-body">
                                    ...
                                    @elseif($policy == 'terms-condtions')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase text-center">Terms and Conditions</h3>
                                            <hr>
                                        </div>
                                        <div class="card-body">
                                    ...
                                    @elseif($policy == 'contact-us')
                                        <h3 class="oswald text-uppercase text-center">Contact Us</h3>
                                        <div class="card-body">
                                            <div class="row">
            ...
            @include('index.template-two.footer')
        </div>
    </div>
</body>
