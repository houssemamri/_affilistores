        ...
        <div class="main-panel">
            ...
            <div class="container slider ">
                ...
                @foreach($store->categoryMenu->take(4) as $submenu)
                    @if(count($submenu->category->productCategory->take(4)) > 0)
                        <div class="card-body ">
                            <h2 class="text-center text-uppercase oswald">{{ $submenu->category->name }}</h4>
                            <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-12 product-card">
                                        <a onclick="pageHit('{{ Crypt::encrypt($product->product_id) }}', '{{ Crypt::encrypt($store->id) }}')" href="{{ route('index.product.show', ['subdomain' => $store->subdomain, 'permalink' => $product->product->permalink]) }}">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <p class="text-muted "><small class="bold text-uppercase">{{ $submenu->category->name }}</small></p>
            ...
            <div class="category-wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h3 class="text-uppercase oswald text-center">You Also Might Like</h3>
                        </div>
