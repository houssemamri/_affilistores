                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                    ...
                                    @elseif($policy == 'gdpr-compliance')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase text-center">GDPR Compliance</h3>
                                    ...
                                    @elseif($policy == 'affiliate-disclosure')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase text-center">Affiliate Disclosure</h3>
                                    ...
                                    @elseif($policy == 'cookie-policy')
                                        <div class="card-body text-center">
                                            <h3 class="oswald text-uppercase text-center">Cookie Policy</h3>
