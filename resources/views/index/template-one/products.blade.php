                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 product-slider">
                            ...
                            <!-- tweets here -->
                            <hr>
                            <h3 class="bold text-uppercase">Related Tweets</h3>
                            <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 product-details">
                            <h3 class="text-uppercase">{{ strip_tags($product->name) }}</h3>
                    ...
                    <div class="row customer-reviews">
                        <div class="col-lg-12">
                            <h3 class="bold text-uppercase">Amazon Customer Reviews</h3>
                            <hr>
                    ...
                    <h3 class="bold text-uppercase">Related Products</h3>
                    <hr>
                    <div class="row">
                                ...
                                <div class="card border-primary mb-3">
                                    ...
                                    <div class="card-body product-content">
                                        ...
                                        <h3 class="card-title bold text-success">
                                            ...
                                            @else
                                                <a onclick="affiliateHit('{{ Crypt::encrypt($relatedProduct->product->id) }}', '{{ Crypt::encrypt($store->id) }}')" href="{{ $relatedProduct->product->details_link }}" class="btn btn-primary btn-check-price"><strong>Buy Now</strong></a>
                                            @endif
                                        </h3>
