    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-12">
                <h4 class="text-uppercase bold">About {{ $store->name }}</h4>
                <hr>
                <p>
            ...
            <div class="col-lg-4 col-md-12">
                <h4 class="text-uppercase bold text-center">Categories</h4>
                <hr>
            ...
            <div class="col-lg-4 col-md-12">
                <h4 class="bold text-uppercase">{{ (json_decode($store->storeTheme->footer_settings)->newsletter->heading == '') ? 'Newsletter' : json_decode($store->storeTheme->footer_settings)->newsletter->heading  }}</h4>
                <hr>
