<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top nav-second">
    <div class="container container-fluid">
        <div class="navbar-wrapper">
            <a class="navbar-brand text-uppercase" href="{{ route('index', $store->subdomain) }}">
                <img class="navbar-brand navbar-brand-image" src="{{ asset('img/uploads/' . $store->subdomain . '/logo/' . $store->logo ) }}" alt="logo">
