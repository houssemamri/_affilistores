                            ...
                            <div class="card">
                                @if($policy == 'privacy')
                                    <div class="card-body text-center">
                                        <h3 class="text-capitalize text-center section-title"><span> Privacy Policy </span></h3>
                                    </div>
                                ...
                                @elseif($policy == 'gdpr-compliance')
                                    <div class="card-body text-center">
                                        <h3 class="text-capitalize text-center section-title"><span> GDPR Compliance </span></h3>
                                ...
                                @elseif($policy == 'affiliate-disclosure')
                                    <div class="card-body text-center">
                                        <h3 class="text-capitalize text-center section-title"><span> Affiliate Disclosure </span></h3>
                                ...
                                @elseif($policy == 'cookie-policy')
                                    <div class="card-body text-center">
                                        <h3 class="text-capitalize text-center section-title"><span> Cookie Policy </span></h3>
                                ...
                                @elseif($policy == 'terms-condtions')
                                    <div class="card-body text-center">
                                        <h3 class="text-capitalize text-center section-title"><span> Terms and Conditions </span></h3>
                                    </div>
                                    <div class="card-body">
                                        {!! htmlspecialchars_decode($customerService->terms_conditions) !!}
                                    </div>
                                @elseif($policy == 'contact-us')
                                    <h3 class="text-capitalize text-center section-title"><span> Contact Us </span></h3>
                                    <div class="card-body">
                                        <div class="row">
