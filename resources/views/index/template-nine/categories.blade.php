        ...
        <div class="main-panel">
            ...
            <div class="product-wrapper">
                <div class="container text-center">
                    <h3 class="text-capitalize text-center section-title"><span> {{ $category->name }} </span></h3>
                                ...
                                <div class="card border-primary mb-3">
                                    ...
                                    <div class="card-body text-left product-content">
                                        <h4 class="card-title text-capitalize">
                                            <strong>
                                                <a class="text-muted" onclick="pageHit('{{ Crypt::encrypt($product->product_id) }}', '{{ Crypt::encrypt($store->id) }}')" href="{{ route('index.product.show', ['subdomain' => $store->subdomain, 'permalink' => $product->product->permalink]) }}">
