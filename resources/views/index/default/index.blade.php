...
<body>
    ...
    <div class="wrapper dashboard">
        ...
        <div class="main-panel">
            ...
            @if(count($sliders) > 0)
                @include('index.default.slider')
            @endif
            <div class="category-wrapper">
                <div class="custom-container">
                    <div class="container">
                        <div class="card-body text-center">
                            <h2 class="text-uppercase montserrat bold">Categories</h2>
                            <hr class="c-hr">
                    ...
                    <div class="container">
                        <div class="container blogs-container">
                            @if(count($blogs) > 0)
                                <h2 class="text-uppercase text-center montserrat bold">Blogs</h2>
                                <hr class="c-hr">
                        ...
                        @if(isset($bannerAd))
                        <div class="container">
                            <h2 class="text-uppercase text-center montserrat bold">You Also Might Like</h2>
                            <hr class="c-hr">
