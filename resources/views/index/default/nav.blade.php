<nav class="navbar navbar-expand-lg navbar-dark bg-primary ">
    <div class="container container-fluid">
        <div class="navbar-wrapper">
            <a class="navbar-brand" href="{{ route('index', $store->subdomain) }}">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <form class="navbar-form"  method="get" action="{{ route('index.product.search', ['subdomain' => $store->subdomain]) }}" >
                <div class="input-group no-border">
                    <input class="form-control mr-sm-2" type="text" id="store-search" placeholder="Search" name="keyword" required>
