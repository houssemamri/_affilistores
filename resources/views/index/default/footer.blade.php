<footer class="index-footer montserrat">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-12">
                <h5 class="text-center montserrat">About {{ $store->name }}</h5>
                <hr>
                <p>
            ...
            <div class="col-lg-4 col-md-12">
                <h5 class="text-center montserrat">Categories</h5>
                <hr>
            ...
            <div class="col-lg-4 col-md-12">
                <h5 class="text-center montserrat">{{ (json_decode($store->storeTheme->footer_settings)->newsletter->heading == '') ? 'Newsletter' : json_decode($store->storeTheme->footer_settings)->newsletter->heading  }}</h5>
                <hr>
