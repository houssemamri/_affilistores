                    ...
                    <div class="row">
                        ...
                        @if($policy == 'privacy')
                            <div class="card-body text-center">
                                <h2 class="montserrat text-uppercase">Privacy Policy</h2>
                                <hr class="c-hr">
                            </div>    
                            <div class="card">
                                <div class="card-body">
                        ...
                        @elseif($policy == 'terms-condtions')
                            <div class="card-body text-center">
                                <h2 class="montserrat text-uppercase">Terms and Conditions</h2>
                                <hr class="c-hr">
                            </div>
                            <div class="card">
                                <div class="card-body">
                        ...
                        @elseif($policy == 'contact-us')
                            <div class="card-body text-center">
                                <h2 class="montserrat text-uppercase">Contact Us</h2>
                                <hr class="c-hr">
                            </div>
                            <div class="row">
