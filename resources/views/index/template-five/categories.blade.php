                        ...
                        @foreach($products as $product)
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                <div class="card border-primary mb-3">
                                    ...
                                    <div class="card-body product-content montserrat text-center">
                                        ...
                                        <h3 class="card-title text-success bold">
                                            <span>
                                                ...
                                                @elseif(strcasecmp('clickbank', $product->product->source) == 0)
                                                    <img src="{{ asset('img/clickbank-icon.png') }}" alt="{{ $product->product->source }}" width="40" class="img-fluid">
                                        ...
                                        : html_entity_decode(strip_tags(preg_replace('/<style>(.*?)<\/style>/s', '', html_entity_decode(htmlspecialchars_decode($product->product->description))))) }}</small>
                                    </div>
                                </div>
                            </div>
                            @endif
