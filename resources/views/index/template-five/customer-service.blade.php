        ...
        <div class="main-panel">
            ...
            <div class="product-wrapper">
                <div class="container contact-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="bold text-center text-uppercase">Privacy Policy</h2>
                    ...
                    @elseif($policy == 'gdpr-compliance')
                        <div class="card-body text-center">
                            <h2 class="bold text-center text-uppercase">GDPR Compliance</h2>
                    ...
                    @elseif($policy == 'affiliate-disclosure')
                        <div class="card-body text-center">
                            <h2 class="bold text-center text-uppercase">Affiliate Disclosure</h2>
                    ...
                    @elseif($policy == 'cookie-policy')
                        <div class="card-body text-center">
                            <h2 class="bold text-center text-uppercase">Cookie Policy</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="bold text-center text-uppercase">Terms and Conditions</h2>
                            <div class="card">
                                <div class="card-body">
                    ...
                    @elseif($policy == 'contact-us')
                        <h2 class="bold text-center text-uppercase text-center">Contact Us</h2>
                        <div class="card-body">
                            <div class="row">
