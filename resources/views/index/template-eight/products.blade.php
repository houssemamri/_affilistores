                 ...
                 <div class="information">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade show active" id="description">
                                <div class="description">
                                    <h3 class="text-capitalize text-success"><u>Description</u></h3>
                            ...
                            <div class="tab-pane fade" id="tweet">
                                <h3 class="text-capitalize text-success"><u>Related Tweets</u></h3>
                            ...
                            @if($product->source == 'amazon')
                                <div class="tab-pane fade" id="amazon">
                                    <div class="row customer-reviews">
                                        <h3 class="text-capitalize text-success"><u>AmazonCustomer Reviews</u></h3>
