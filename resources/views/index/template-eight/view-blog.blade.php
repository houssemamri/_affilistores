        ...
        <div class="main-panel">
            ...
            <div class="product-wrapper">
                <div class="container">
                    ...
                    <h3 class="text-capitalize text-success"><u>Related Products</u></h3>
                                ...
                                <div class="card border-primary mb-3">
                                    ...
                                    <div class="card-body product-content">
                                        <h4 class="card-title bold text-uppercase">
                                            <strong>
                                                <a onclick="pageHit('{{ Crypt::encrypt($blogProduct->product_id) }}', '{{ Crypt::encrypt($store->id) }}')" href="{{ route('index.product.show', ['subdomain' => $store->subdomain, 'permalink' => $blogProduct->product->permalink]) }}">
                                                    {{ strlen($blogProduct->product->name) > 30 ? substr($blogProduct->product->name, 0, 30) . "..." : $blogProduct->product->name }}
                                                </a>
                                            </strong>
                                        </h4>
                                        <h3 class="card-title bold text-success">
                                            ...
                                            @else
                                                <a onclick="affiliateHit('{{ Crypt::encrypt($blogProduct->product_id) }}', '{{ Crypt::encrypt($store->id) }}')" href="{{ $blogProduct->product->details_link }}" class="btn btn-primary btn-check-price"><strong>Buy Now</strong></a>
                                            @endif
                                        </h3>
