                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                @elseif($policy == 'gdpr-compliance')
                                    <div class="card-body text-center">
                                        <h2 class="montserrat text-uppercase">GDPR Compliance</h2>
                                        <hr class="c-hr">
                                    </div>    
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                @elseif($policy == 'affiliate-disclosure')
                                    <div class="card-body text-center">
                                        <h2 class="montserrat text-uppercase">Affiliate Disclosure</h2>
                                        <hr class="c-hr">
                                    </div>    
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                @elseif($policy == 'cookie-policy')
                                    <div class="card-body text-center">
                                        <h2 class="montserrat text-uppercase">Cookie Policy</h2>
                                        <hr class="c-hr">
                                    </div>    
                                    <div class="card">
                                        <div class="card-body">
