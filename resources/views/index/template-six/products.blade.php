                ...
                <div class="container">
                            ...
                            <div id="accordion">
                                <div class="card">
                                    ...
                                    <h4 class="mb-0 mt-0">
                                        ...
                                        <button class="btn btn-link btn-collapse" data-toggle="collapse" data-target="#collapseDescription" aria-expanded="true" aria-controls="collapseDescription">
                                ...
                                <div class="card">
                                    ...
                                    <h4 class="mb-0 mt-0">
                                        ...
                                        <button class="btn btn-link btn-collapse" data-toggle="collapse" data-target="#collapseTweets" aria-expanded="true" aria-controls="collapseTweets">
                                            <i class="material-icons">remove</i>
                                        </button>
                                    </h4>
                                    </div>
                    ...
                    <div class="information-container">
                        <div class="row customer-reviews">
                            <div class="col-lg-12">
                                <h2 class="bold text-center text-uppercase">Amazon Customer Reviews</h2>
