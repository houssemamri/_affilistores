...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Create Category </strong></h4>
        <p class="card-category">Add new category for your products</p>
    </div>
    <div class="card-body">
        <form action="{{ route('categories.create', ['subdomain' => Session::get('subdomain')]) }}" method="POST" enctype="multipart/form-data">
            {!! csrf_field() !!}
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" placeholder="Enter Category Name" value="{{ old('name') }}" class="form-control category-name">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="permalink">
                               <span>{{ URL::to('/') }}/category/<span class="permalink">{{ old('permalink') }}</span></span> 
                               <input type="hidden" name="permalink" value="{{ old('permalink') }}" >
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="meta_title" placeholder="Enter Meta Title" value="{{ old('meta_title') }}" class="form-control">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" name="robots_meta_no_index">
                                    Set to active
                        ...
                        <tr>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" name="robots_meta_no_follow">
                                    Set to active
                                    <span class="form-check-sign">
                                        <span class="check"></span>
                                    </span>
