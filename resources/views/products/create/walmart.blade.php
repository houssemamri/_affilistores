...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Add A New Walmart Product </strong></h4>
...
@section('custom-scripts')
    ...
    <script>
        ...
        $('.search').on('click', function(){
            ...
            axios.post("{{ route('walmart.search', ['subdomain' => Session::get('subdomain')]) }}", {
                ...
                $.each(products, function(index, product){
                    ...
                    var data = {
                        ...
                        currency: 'USD',
                        price: price,
                        details_link: escape(product.productUrl),
                        description: (product.longDescription) ? escape(product.longDescription.toString()) : '',
                        images: (product.imageEntities) ? getImages(product.imageEntities) : [],
                    ...
                    html += '<tr>';
                    html += '   <td></td>';
                    html += '   <td>'+ product.itemId +'</td>';
                    html += "   <td><input class='product-data' type='hidden' value='"+ data +"'>"+ product.name +"</td>";
                    html += '   <td><img src="'+ image.replace('http:', 'https:') +'" width="60%" alt="'+ product.itemId +'" class="img-fluid"></td>';
                    html += '   <td>'+ price +'</td>';
                    html += '   <td><a href="'+ product.productUrl +'" target="_blank">View Details</a></td>';
                    html += '</tr>';
