...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Add A New AliExpress Product </strong></h4>
...
@section('custom-scripts')
    ...
    <script>
        function getImage(product){
            ...
            return image.indexOf('https') == -1 ? image.replace('http', 'https') : image;
        }
        ...
        $('.search').on('click', function(){
            ...
            axios.post("{{ route('aliexpress.search', ['subdomain' => Session::get('subdomain')]) }}", {
                ...
                $.each(products, function(index, product){
                    ...
                    var url = product.url.indexOf('https') == -1 ? product.url.replace('http', 'https') : product.url;
                    ...
                    html += '   <td><img src="'+ image +'" width="60%" alt="'+ product.id +'" class="img-fluid"></td>';
                    html += '   <td>$'+ price +'</td>';
                    html += '   <td><a href="'+ url +'" target="_blank">View Details</a></td>';
                    html += '</tr>';
