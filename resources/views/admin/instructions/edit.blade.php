...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Edit Instructions </strong></h4>
        <p class="card-category">Update your market place instructions</p>
    </div>
    <div class="card-body">
        <form action="{{ route('instructions.edit', $id) }}" method="POST">
            {!! csrf_field() !!}
            ...
            <div class="form-group">
                ...
                <select name="market_place" id="" class="form-control">
                    ...
                    <option value="{{ $key }}" {{ $instruction->market_place == $key ? 'selected' : '' }}>{{ $marketPlace }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                <textarea class="form-control" name="instructions" id="editor-body">{!! $instruction->instructions !!}</textarea>
            </div>
