...
<form action="create.php" method="POST" id="wizard">
    ...
    <div class="step6" style="">
        ...
        <div class="contentWizard" style="margin-left:-85px;" >
        
    <object style=" margin-bottom:-2px;" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="939" height="636" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0"><param name="name" value="blog1" /><param name="bgcolor" value="#FFFFFF" /><param name="align" value="middle" /><param name="src" value="editors/creator2.swf" /><param name="allowfullscreen" value="false" /><param name="quality" value="high" /><embed style=" margin-bottom:-2px;" type="application/x-shockwave-flash" width="939" height="636" src="editors/creator2.swf" quality="high" allowfullscreen="false" align="middle" bgcolor="#FFFFFF" name="blog1"></embed></object>
