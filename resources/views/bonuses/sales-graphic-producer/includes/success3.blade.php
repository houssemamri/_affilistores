...
<form action="create.php" method="POST" id="wizard">
   ...
   <embed src="editors/creator3.swf" quality="high" bgcolor="#FFFFFF" width="939" height="776" name="blog1" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" style="margin-bottom: -1px;" />  
