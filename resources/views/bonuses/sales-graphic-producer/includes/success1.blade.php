...
<form action="create.php" method="POST" id="wizard">
    ...
    <div class="step6" style="">
        ...
        <div class="contentWizard" style="margin-left:-80px;" >
          ...
          <embed src="editors/creator1.swf" quality="high" bgcolor="#FFFFFF" width="939" height="695" name="blog1" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.adobe.com/go/getflashplayer" style="margin-bottom: -2px;" />
