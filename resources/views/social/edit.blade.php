...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Edit Social Campaign </strong></h4>
        <p class="card-category">Update social campaign</p>
    </div>
    <div class="card-body">
    ...
    <div class="card-body">
        <form action="{{ route('social.edit', ['subdomain' => Session::get('subdomain'), 'id' => $id]) }}" method="POST">
            {!! csrf_field() !!}
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="automation_name" value="{{ $socialCampaign->name }}" placeholder="Enter Automation Name" class="form-control category-name">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="category" id="" class="category">
                                            ...
                                            <option value="{{ $category->id }}" {{  $socialCampaign->category_id == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="checkbox" name="enable_autopost" {{ $socialCampaign->enable_autopost == 1 ? 'checked' : ''}}>
                                                Set to enable
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="date" name="schedule_date" min="{{ date('Y-m-d') }}" value="{{ $socialCampaign->schedule_date }}" class="form-control" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="schedule_time" id="" class="form-control" readonly>
                                            @for($i = 0; $i <= 24; $i++)
                                            <option value="{{ $i . ':00' }}" {{ ($socialCampaign->schedule_time == ($i . ':00')) ? 'selected' : '' }}>{{ $i . ':00' }}</option>
                                            @endfor
                                        </select>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <select id="productList" class="form-control">
                                            @foreach($products as $product)
                                                @if(!in_array($product->product_id, json_decode($socialCampaign->products)))
                                        ...
                                        <div class="selected">
                                            @foreach($products as $product)
                                                @if(in_array($product->product_id, json_decode($socialCampaign->products)))
                                                <span>
                                                    <input type="hidden" name="products[]" value="{{ $product->product_id }}" data-name="{{ $product->product->name }}">
                                                    <span class="badge badge-primary product-badge">{{ $product->product->name }}</span>
                                                    <span class="badge badge-default product-remove" onclick="remove(this);">X</span>
                                                </span>
                                                @endif
                                            @endforeach
                                        </div>
                            ...
                            <tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        {{-- <td>
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox" value="facebook_timeline" name="type[]" {{ ($socialCampaign->campaigns->where('type', 'facebook_timeline')->first() !== null) ? 'checked' : ''}}>
                                                                    Post to Timeline
                                                                    <span class="form-check-sign">
                                                                        <span class="check"></span>
                                                                    </span>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox" value="facebook_pages" name="type[]" {{ ($socialCampaign->campaigns->where('type', 'facebook_pages')->first() !== null) ? 'checked' : ''}}>
                                                                    Post to Pages
                                                                    <span class="form-check-sign">
                                                                        <span class="check"></span>
                                                                    </span>
                                                        ...
                                                        {{-- <td>
                                                            <div class="form-check">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input" type="checkbox" value="facebook_groups" name="type[]" {{ ($socialCampaign->campaigns->where('type', 'facebook_groups')->first() !== null) ? 'checked' : ''}}>
                                                                    Post to Groups
                                                                    <span class="form-check-sign">
                                                                        <span class="check"></span>
                                                                    </span>
                                ...
                                <tr width="30%">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="checkbox" value="twitter" name="type[]" {{ ($socialCampaign->campaigns->where('type', 'twitter')->first() !== null) ? 'checked' : ''}}>
                                                Twitter Timeline
                                                <span class="form-check-sign">
                                                    <span class="check"></span>
                                                </span>
                                ...
                                <tr width="30%">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="checkbox" value="tumblr" name="type[]"  {{ ($socialCampaign->campaigns->where('type', 'tumblr')->first() !== null) ? 'checked' : ''}}>
                                                Tumblr Post
                                                <span class="form-check-sign">
                                                    <span class="check"></span>
                                                </span>
                                ...
                                <tr width="30%">
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="checkbox" value="pinterest" name="type[]"  {{ ($socialCampaign->campaigns->where('type', 'pinterest')->first() !== null) ? 'checked' : ''}}>
                                                Pinterest Pin
                                                <span class="form-check-sign">
                                                    <span class="check"></span>
                                                </span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="checkbox" value="instagram" name="type[]" {{ ($socialCampaign->campaigns->where('type', 'instagram')->first() !== null) ? 'checked' : ''}}>
                                                Instagram post
                                                <span class="form-check-sign">
                                                    <span class="check"></span>
                                                </span>
...
@section('custom-scripts')
    ...
    <script>
        ...
        var limitcounter = "{{ count(json_decode($socialCampaign->products)) }}";
