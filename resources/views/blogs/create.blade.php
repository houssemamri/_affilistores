...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Add New Blog </strong></h4>
        <p class="card-category">Add blog to your store</p>
    </div>
    <div class="card-body">
        <form action="{{ route('blogs.create', Session::get('subdomain')) }}" method="POST">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="post" id="editor-body">{!! old('post') !!}</textarea>
                    </div>
                </div>
            </div>
...
@section('custom-scripts')
    ...
    <script>
        ...
        $('.btn-spin').on('click', function(){
            ...
            var text = $($("#editor-body").summernote("code")).text();
