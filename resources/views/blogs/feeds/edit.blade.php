...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong> Edit Blog Feed </strong></h4>
        <p class="card-category">Update feed details</p>
    </div>
    <div class="card-body">
        <form action="{{ route('blogs.feeds.edit', ['subdomain' => Session::get('subdomain'), 'id' => $id]) }}" method="POST">
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="url" value="{{ $feed->url }}" class="form-control" >
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <select name="category" id="" class="form-control">
                            ...
                            <option value="{{ $category->id }}" {{ $category->id == $feed->blog_category_id ? 'selected' : ''}}>{{ $category->title }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <select name="product_category" id="" class="form-control">
                            ...
                            <option value="{{ $productCategory->id }}" {{ $feed->category_id == $productCategory->id ? 'selected' : ''}}>{{ $productCategory->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="date" name="from" value="{{ $feed->automation->from }}" class="form-control" >
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="date" name="to" value="{{ $feed->automation->to }}" class="form-control" >
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <select name="frequency" id="" class="form-control">
                            <option value="daily" {{ $feed->automation->frequency == 'daily' ? 'selected' : '' }}>Daily</option>
                            <option value="weekly" {{ $feed->automation->frequency == 'weekly' ? 'selected' : '' }}>Weekly</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="auto_publish" {{ $feed->automation->auto_publish == 1 ? 'checked' : '' }}>
                            Enable Auto Publish
