...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title"><strong>Social Proof </strong></h4>
        <p class="card-category">Create your custom social proof</p>
    </div>
    <div class="card-body">
        <form action="{{  route('socialProof.create', ['subdomain' => Session::get('subdomain')]) }}" method="POST" enctype="multipart/form-data">
            {!! csrf_field() !!}
            <div class="row">
