...
@section('content')
<form action="{{ route('subadmin.updateProfile') }}" method="POST" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('subadmin.dashboard') }}"class="btn btn-danger">Cancel</a>
            <div class="clearfix"></div>
        </div>
    </div>
</form>
<form action="{{ route('subadmin.updatePassword') }}" method="POST">
    {!! csrf_field() !!}
    <div class="card">
        <div class="card-header card-header-primary">
