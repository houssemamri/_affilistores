...
use App\Http\Controllers\Subadmin\GlobalController;
...
class MemberController extends GlobalController
{
    public function index(){
        ...
        return view('subadmin.members.index', compact('members', 'memberships'));
    }
    ...
    public function create(Request $request){
        ...
        if($request->isMethod('POST')){
            ...
            if($request->password == $request->confirm_password){
                ...
                if($unique == 0){
                    ...
                    return redirect()->route('subadmin.members.index');
                }else{
        ...
        return view('subadmin.members.create', compact('memberships'));
    }
    ...
    public function edit(Request $request, $id){
        ...
        return view('subadmin.members.edit', compact('id', 'user', 'memberships'));
    }
    ...
    public function ipnList(){
        $ipns = Ipn::all();
        return view('subadmin.members.ipn', compact('ipns'));
    }
}
